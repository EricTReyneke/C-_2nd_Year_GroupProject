...
VALUES (5000,'Kieran Mckenzie','Female','1999-01-20','(790) 247-3753','Ap #729-4357 Ut St.',3,1),
  ...
  drop procedure spUpdateStudents
 ...
 as begin
  Update StudentDetails set Student_Number = @id, Student_Name = '@Name', Gender = '@Gender'
 end
 ...
 as begin
  insert StudentDetails(Student_Number, Student_Name, Gender) values(@ID, '@Name', '@Gender')
 end
